...
def ine_pipeline(processor, parser, ine_imagen, agent=None, page=0, ocr_engine="paddle"):
...
async def parse_ine(
    ...
    try:
        ...
        result = ine_pipeline(processor=processor, parser=parser, ine_imagen=tmp_path, page=page, ocr_engine=ocr_engine, agent=agent)
